...
class ModelTestCase(TestCase):
    def setUp(self):
        ...
        self.inventory = Inventory.objects.create(
            sku=self.sku, category=self.category, user=self.user, quantity=100
        )
    ...
    def test_sku_fields(self):
        ...
        self.assertTrue(
            self.sku.shelf_life_end,
            self.sku.manufacturing_date + relativedelta(months=24),
        )
