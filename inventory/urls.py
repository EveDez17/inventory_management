...
from .views import (
    ...
    search_skus,
    InventorySearchResultsView,
    SKUDetailView,
    AddSKUView,
    sku_added_success_view,
    DeleteSKUView,
    sku_delete_list_view,
    perform_sku_deletion,
    EditSKUView,
    sku_list_view,
)
...
urlpatterns = [
    ...
    path(
        "search/", InventorySearchResultsView.as_view(), name="inventory_search_results"
    ),
